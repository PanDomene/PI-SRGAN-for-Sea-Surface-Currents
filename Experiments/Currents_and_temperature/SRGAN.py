...
hr_images = load_and_combine_channels(train_hr_folder, "temp")
lr_images = load_and_combine_channels(train_lr_folder, "temp")
val_hr = load_and_combine_channels(val_hr_folder, "temp")
val_lr = load_and_combine_channels(val_lr_folder, "temp")
